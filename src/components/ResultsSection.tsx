        ...
        {[
          {
            ...
            sub: (
              <div
                class={`text-[10px] md:text-xs mt-1 flex items-center justify-center gap-1 ${statistics.avgTimeInQueue < 2 ? "text-success-400" : "text-warning-400"}`}
              >
          ...
          <motion.div
            key={i}
            class="card text-center p-3 md:p-6"
          ...
          >
            <item.icon
              class={`w-6 h-6 md:w-8 md:h-8 ${item.color} mx-auto mb-2`}
            />
            <div class={`text-xl md:text-2xl font-bold ${item.color}`}>
              {item.value}
            </div>
            <div class="text-[10px] md:text-xs text-white/50">{item.label}</div>
            {item.sub}
          </motion.div>
        ))}
      </div>

      <div class="flex flex-wrap gap-2 p-1 bg-dark-300/50 rounded-xl justify-center md:justify-start">
        {[
          ...
          <button
            ...
            class={`relative flex-1 md:flex-none px-3 py-2 md:px-4 md:py-3 rounded-lg text-xs md:text-sm font-medium transition-all flex items-center justify-center gap-2 z-10 ${
              activeTab === tab.id
                ? "text-white"
          ...
          >
            ...
            <tab.Icon class="w-3 h-3 md:w-4 md:h-4" />
            <span class="relative z-10 whitespace-nowrap">{tab.label}</span>
          </button>
        ))}
      </div>
            ...
            {activeTab === "stats" && (
              <div class="space-y-6">
                ...
                <div class="p-4 rounded-lg bg-dark-300/50">
                  <h4 class="font-semibold mb-3 text-primary-300">
                    Parameter Input
                  </h4>
                    ...
                    <div class="space-y-3 text-sm">
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono">
                          {statistics.avgInterarrivalTime.toFixed(4)} min
                        </span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-white/60">Avg Service Time</span>
                        <span class="font-mono">
                          {statistics.avgServiceTime.toFixed(4)} min
                        </span>
                      </div>
                      ...
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono">
                          {statistics.maxTimeInQueue.toFixed(4)} min
                        </span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-white/60">Total Simulation Time</span>
                        <span class="font-mono">
                          {statistics.totalSimulationTime.toFixed(2)} min
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="p-4 rounded-lg bg-accent-500/10 border border-accent-500/20">
                    ...
                    <div class="space-y-3 text-sm">
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono">
                          {(1 / parameters.lambda).toFixed(4)} min
                        </span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-white/60">E[Service] = 1/μ</span>
                        <span class="font-mono">
                          {(1 / parameters.mu).toFixed(4)} min
                        </span>
                      </div>
                      <hr class="border-white/10" />
                      <div class="flex justify-between font-semibold">
                      ...
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono">
                          {theoretical.avgQueueLength.toFixed(4)}
                        </span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-white/60">L (System Length)</span>
                        <span class="font-mono">
                          {theoretical.avgSystemLength.toFixed(4)}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div class="p-4 rounded-lg bg-success-500/10 border border-success-500/20">
                  ...
                  <p class="text-xs text-white/50 mt-3">
                    * Semakin kecil error, semakin akurat simulasi Monte Carlo
                    terhadap nilai teoritis M/M/1
                  </p>
                </div>
              </div>
            )}
